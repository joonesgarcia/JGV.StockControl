...
namespace JGV.StockControl.Library.Migrations
{
    ...
    [Migration("20240212191351_Payments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JGV.StockControl.Library.DAL.Models.Debt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("WillBePaidIn")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("JGV.StockControl.Library.DAL.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("JGV.StockControl.Library.DAL.Models.Payment", b =>
                {
                    b.HasOne("JGV.StockControl.Library.DAL.Models.Debt", "Debt")
                        .WithMany("Payments")
